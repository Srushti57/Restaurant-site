    ...
    <div class="wrapper">
        ...
        <?php
            if(isset($_GET['id']))
            {
                ...
                {
                    header('location:'.SESSION_URL.'admin/manage-order.php');
                ...
                <tr>
                    ...
                    <td>
                        <select name="status" id="">
                            ...
                            <option <?php if($status=="On Delievery"){echo "selected";}?>value="On Delievery">On Delievery</option>
        ...
        <?php
            if(isset($_POST['submit']))
            {
                ...
                {
                    $_SESSION['update'] = "<div class='fail'>Order failed to Update</div>";
                    header('location:'.SESSION_URL.'admin/manage-order.php');
                }
            }
            else
